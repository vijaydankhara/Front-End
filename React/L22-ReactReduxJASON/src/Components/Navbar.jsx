...
const Navbar = () => {
  ...
  return (
    <>
      <div className="Dankhara w-full h-28 flex justify-between items-center z-50 sticky top-0 bg-white shadow-md">
        <div className="container flex items-center justify-between mx-auto px-5">
          {/* Logo */}
          <NavLink to="/" className="flex items-center">
            <img id="logo" className="size-16" src={VdLogo} alt="Logo" />
          </NavLink>

          {/* Navigation Links */}
          <div className="hidden md:flex space-x-8" id="toggle">
            <div
              className="relative"
          ...
          <div className="flex items-center space-x-6">
            <div className="relative">
              <NavLink to="/cart">
                ...
                <span className="absolute top-[-20px] right-[-20px] border rounded-full px-2 py-1 text-xs text-white bg-[#ff0000]">
                  0
                </span>
              </NavLink>
            </div>
