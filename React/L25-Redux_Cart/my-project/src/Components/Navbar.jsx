...
const Navbar = () => {
  ...
  return (
    <>
      <div className="w-full p-6 flex justify-around items-center z-50 sticky top-0 bg-[#ee933d] border-b-4 border-[#4229ff]">
            ...
            <div className="flex items-center space-x-4 mr-1">
              ...
              <div className="relative">
                <NavLink to="/wishlist">
                  ...
                  <span className="absolute top-0 right-5  transform translate-x-1/2 -translate-y-1/2 border-2 rounded-full px-1  text-[#fff] bg-[#ff0000] text-xs">{resultWish.length}</span>
                </NavLink>
              </div>
            </div>
          </div>
